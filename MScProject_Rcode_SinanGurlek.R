...
data_fin<-read_xlsx("/Users/sinangurlek/Downloads/iCloud Drive (Arşiv)/Documents/IC/Project/MScProject_Data_SinanGurlek/FunTrait_data_SG.xlsx", sheet=1)

#IUCN data 
IUCN6<-read_xlsx("/Users/sinangurlek/Downloads/iCloud Drive (Arşiv)/Documents/IC/Project/MScProject_Data_SinanGurlek/IUCN_data_SG.xlsx", sheet=1)
IUCN6<-IUCN6[,c(1,3)]
...
roc_curve<-roc(glm_Max1$model$stateIUCN, predicted1 )
plot(roc_curve)
